	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Shangrila</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'room.php') || ($cur_page == 'room-add.php') || ($cur_page == 'room-edit.php') ) {echo 'active';} ?>">
                        <a href="room.php">
                            <i class="fa fa-shopping-bag"></i> <span>Room Management</span>
                        </a>
                    </li>

					<li class="treeview <?php if( ($cur_page == '#') ) {echo 'active';} ?>">
			          <a href="offer.php">
			            <i class="fa fa-tasks"></i> <span>Rate Plan Management</span>
			          </a>
			        </li>

					<li class="treeview <?php if( ($cur_page == '#') ) {echo 'active';} ?>">
                        <a href="reservation.php">
                            <i class="fa fa-sticky-note"></i> <span>Reservation Management</span>
                        </a>
                    </li>
